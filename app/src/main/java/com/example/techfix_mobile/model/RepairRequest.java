...
public class RepairRequest {
    ...
    // Status lifecycle constants (section 3 of the doc)
    ...
    // Not part of Firestore doc — local-only helper fields
    private String syncStatus = "synced"; // 'pending' | 'synced' | 'failed'

    public RepairRequest() {
        // required no-arg constructor for Firestore's toObject()
    }
    ...
    /** True once the repair is done and payment can be taken. */
